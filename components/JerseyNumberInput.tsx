...
export default function JerseyNumberInput({ value, onChange, onClose, title = 'Enter Jersey Number' }: JerseyNumberInputProps) {
  ...
  // Format value for display (pad to 2 digits)
